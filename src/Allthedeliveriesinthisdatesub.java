...
public class Allthedeliveriesinthisdatesub extends JFrame {
	...
	public Allthedeliveriesinthisdatesub(SubManager submanagerCheck) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Allthedeliveriesinthisdatesub.this.setVisible(false);
		...
		btnNewButton.setBounds(752, 66, 89, 23);
		panel.add(btnNewButton);
		
		JLabel lblNewLabel_1 = new JLabel("Enter day,month and year:");
		lblNewLabel_1.setBounds(24, 66, 144, 29);
